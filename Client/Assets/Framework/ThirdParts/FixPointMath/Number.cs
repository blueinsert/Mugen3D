            ...
            partial struct Number {
                public static readonly long[] AcosLut = new[] {");
                        ...
                        for (int i = 0; i < LUT_SIZE; ++i) {
                            ...
                            var rawValue = ((Number)acos)._serializedValue;
            ...
            partial struct Fix64 {
                public static readonly long[] SinLut = new[] {");
                        ...
                        for (int i = 0; i < LUT_SIZE; ++i) {
                            ...
                            var rawValue = ((Number)sin)._serializedValue;
                            writer.Write(string.Format("0x{0:X}L, ", rawValue));
                        }
                        writer.Write(
        @"
            ...
            partial struct Fix64 {
                public static readonly long[] TanLut = new[] {");
                        ...
                        for (int i = 0; i < LUT_SIZE; ++i) {
                            ...
                            var rawValue = (((decimal)tan > (decimal)MaxValue || tan < 0.0) ? MaxValue : (Number)tan)._serializedValue;
                            writer.Write(string.Format("0x{0:X}L, ", rawValue));
                        }
                        writer.Write(
        @"
