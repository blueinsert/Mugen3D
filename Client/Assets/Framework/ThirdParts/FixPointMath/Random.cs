...
namespace FixPointMath{
    ...
    /**
     *  @brief Static instance of {@link Random} with seed 1.
     **/
     ...
     **/
    public static Random New(int seed) {
    ...
    /**
     *  @brief Returns a {@link Number} between a min value [inclusive] and a max value [inclusive].
     **/
    public Number Next(float minValue, float maxValue) {
        ...
        return (Number.Floor((maxValueInt - minValueInt + 1) * NextNumber() +
            minValueInt)) / 1000;
    }
     ...
     *  @brief Returns a {@link Number} between a min value [inclusive] and a max value [inclusive].
     **/
    public static Number Range(float minValue, float maxValue) {
        return instance.Next(minValue, maxValue);
    }

    /**
     *  @brief Returns a {@link Number} between 0.0 [inclusive] and 1.0 [inclusive].
     **/
    public Number NextNumber() {
        return ((Number) Next()) / (MaxRandomInt);
    }
    ...
    Number genrand_FP() {
        return (Number)genrand_int32() * (Number.One / (Number)4294967295);
    }
